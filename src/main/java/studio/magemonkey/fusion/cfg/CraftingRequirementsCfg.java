...
public class CraftingRequirementsCfg {
    ...
    public static String getMoney(String path, double money, double required) {
        ...
        String line = config.getString(path + ".money." + (fulfilled ? "true" : "false"), fulfilled ? "&6- &eMoney: &7(&a$$<money>&8/&7$$<required>&7)" : "&6- &eMoney: &7(&c$$<money>&8/&7$$<required>&7)");
    ...
    public static String getExp(String path, int experience, int required) {
        ...
        String line = config.getString(path + ".exp." + (fulfilled ? "true" : "false"), fulfilled ? "&6- &eExperience: &7(&a<exp>&8/&7<required>&7)" : "&6- &eExperience: &7(&c<exp>&8/&7<required>&7)");
    ...
    public static String getProfessionLevel(String path, int level, int required) {
        ...
        String line = config.getString(path + ".professionLevel." + (fulfilled ? "true" : "false"), fulfilled ? "&6- &eLevel Needed: &7(&a<level>&8/&7<required>&7)" : "&6- &eLevel Needed: &7(&c<level>&8/&7<required>&7)");
    ...
    public static String getMastery(String path, boolean mastery, boolean required) {
        ...
        String line = config.getString(path + ".mastery." + (fulfilled ? "true" : "false"), fulfilled ? "&6- &eMastery: &7(&a<mastery>&8/&7<required>&7)" : "&6- &eMastery: &7(&c<mastery>&8/&7<required>&7)");
    ...
    public static String getRank(String path, String rank) {
        return ChatUT.hexString(config.getString(path + ".rank." + rank, "&c" + rank + " rank needed to craft this item!"));
    }
    ...
    public static String getCanCraft(boolean fulfilled) {
        return ChatUT.hexString(config.getString("recipes.canCraft." + (fulfilled ? "true" : "false"), (fulfilled ? "&aYou can craft this item." : "&cYou can't craft this item.")));
    }

    public static String getLimit(String path, int limit, int maxLimit) {
        boolean fulfilled = limit < maxLimit;
        String line = config.getString(path + ".limit." + (fulfilled ? "true" : "false"), fulfilled ? "&6- &eLimit: &7(&a<limit>&8/&7<required>&7)" : "&6- &eLimit: &7(&c<limit>&8/&7<required>&7)");
    ...
    public static String getCanJoin(boolean fulfilled) {
        return ChatUT.hexString(config.getString("professions.canJoin." + (fulfilled ? "true" : "false"), (fulfilled ? "&aYou can join this profession." : "&cYou can't join this profession.")));
    }
}
