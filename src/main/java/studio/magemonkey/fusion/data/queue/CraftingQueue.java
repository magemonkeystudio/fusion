...
public class CraftingQueue {
    ...
    public void addRecipe(Recipe recipe) {
        ...
        FusionAPI.getEventServices().getQueueService().addQueueItem(player, ProfessionsCfg.getTable(profession), this, item);
    }
    ...
    public void finishRecipe(QueueItem item) {
        if (item.isDone()) {
            ...
            FusionAPI.getEventServices().getQueueService().finishQueueItem(player, ProfessionsCfg.getTable(profession), this, item, recipeItem.getItemStack(), recipeItem.getAmount());
        }
    }
    ...
    public void removeRecipe(QueueItem item, boolean refund) {
        ...
        FusionAPI.getEventServices().getQueueService().cancelQueueItem(player, ProfessionsCfg.getTable(profession), this, item, !refund, refund, refund ? item.getRecipe().getItemsToTake() : List.of());
    }
