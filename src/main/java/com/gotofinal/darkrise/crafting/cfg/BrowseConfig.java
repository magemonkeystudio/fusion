...
public class BrowseConfig {
    ...
    private static void attemptPort() {
        ...
        boolean changed = conf.contains("browse.name") || conf.contains("browse.fillItem") || conf.contains("browse.pattern");
    ...
    private static void setDefaults() {
        ...
        browseItems.put('0', ItemBuilder.newItem(Material.BIRCH_SIGN).name("&3Crafting Groups").insertLoreLine(0, ChatColor.GRAY + "Select a group to get started!").build());
        browseItems.put('1', ItemBuilder.newItem(Material.CYAN_STAINED_GLASS_PANE).name(" ").build());

        InventoryPattern browsePattern = new InventoryPattern(new java.lang.String[]{"111101111", "ooooooooo", "ooooooooo"}, browseItems);
